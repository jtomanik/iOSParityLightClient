...
//        testCalculatingDAGItem()
    ...
    private func testEmptyKeccak256() {
        ...
        var tmp = ethash_h256_short_t()
        tmp.bytes = (
            0xc5, 0xd2, 0x46, 0x01, 0x86, 0xf7, 0x23, 0x3c, 0x92, 0x7e, 0x7d, 0xb2, 0xdc, 0xc7, 0x03, 0xc0,
            0xe5, 0x00, 0xb6, 0x53, 0xca, 0x82, 0x27, 0x3b, 0x7b, 0xfa, 0xd8, 0x04, 0x5d, 0x85, 0xa4, 0x70)
        copy_ethash_h256(&tmp, &expected)
    ...
    private func testCacheGeneration() {
        ...
        copy_ethash_node(&tmp1, &expectedFirstNode)

        var expectedLastNode = ethash_node_t()
        var tmp2 = ethash_node_short_t()
        tmp2.bytes = (
        ...
        copy_ethash_node(&tmp2, &expectedLastNode)
        ...
        backend.generateCache(for: blockNumber) { result in
            ...
            if firstNode == expectedFirstNode && lastNode == expectedLastNode {
                ...
                print(firstNode.double_words)
                print(lastNode.double_words)
        ...
        backend.calculateLightClient(for: blockNumber, hash: hash, nonce: nonce) { [backend] result in
            ...
            if result.success {
                ...
                if check1 {
                    ...
                    print("\(m1.double_words.0)")
                    print("\(result.mix_hash.double_words.0)")
