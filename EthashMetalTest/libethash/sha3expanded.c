...
# 1 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stdint.h" 1 3 4
# 63 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stdint.h" 3 4
...
# 64 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stdint.h" 2 3 4
# 8 "./sha3.h" 2
...
# 1 "./ethash.h" 1
# 24 "./ethash.h"
# 1 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stdbool.h" 1 3 4
# 25 "./ethash.h" 2
...
# 26 "./ethash.h" 2
# 1 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stddef.h" 1 3 4
# 51 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 118 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stddef.h" 3 4
# 1 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/__stddef_max_align_t.h" 1 3 4
# 32 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/__stddef_max_align_t.h" 3 4
typedef long double max_align_t;
# 119 "/Applications/Xcode_10_GM.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/10.0.0/include/stddef.h" 2 3 4
# 27 "./ethash.h" 2
# 52 "./ethash.h"
...
# 68 "./ethash.h"
    ...
    _Bool ethash_compute_cache_nodes(
...
static inline void keccakf(void *state) {
    ...
    for (int i = 0; i < 24; i++) {
        ...
        x = 0;
        y = 0;
        a[y + x] ^= b[(x + 4) % 5] ^ (((b[(x + 1) % 5]) << 1) | ((b[(x + 1) % 5]) >> (64 - 1)));
        y += 5;
        a[y + x] ^= b[(x + 4) % 5] ^ (((b[(x + 1) % 5]) << 1) | ((b[(x + 1) % 5]) >> (64 - 1)));
        y += 5;
        a[y + x] ^= b[(x + 4) % 5] ^ (((b[(x + 1) % 5]) << 1) | ((b[(x + 1) % 5]) >> (64 - 1)));
...
# 114 "sha3.c"
static inline void xorin( ethash_uint8_t* dst, const ethash_uint8_t* src, size_t len ) { do { for (size_t i = 0; i < len; i += 1) { dst[i] ^= src[i]; } } while (0); }
static inline void setout( const ethash_uint8_t* src, uint8_t* dst, size_t len ) { do { for (size_t i = 0; i < len; i += 1) { dst[i] = src[i]; } } while (0); }
# 129 "sha3.c"
...
static inline void mem_clear_200(ethash_uint8_t *b)
{
    ...
    for (ethash_uint32_t i = 0; i < 200 / 4; i++) {
        buffer[i] = 0;
    }
}
...
{
    if ((out == ((void*)0)) || ((in == ((void*)0)) && inlen != 0) || (rate >= 200)) {
        return -1;
    }
    ethash_uint8_t a[200] = {0};
